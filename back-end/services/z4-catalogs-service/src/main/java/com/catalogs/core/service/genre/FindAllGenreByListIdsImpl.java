...
@Service("findAllGenreByListIdsImpl")
public class FindAllGenreByListIdsImpl extends GenericFindAllByListIdsService<GenreEntity, GenreDto, Integer> {

    private final GenreRepository genreRepository;
    private final GenreMapper genreMapper;

    public FindAllGenreByListIdsImpl(GenreRepository genreRepository, GenreMapper genreMapper) {
